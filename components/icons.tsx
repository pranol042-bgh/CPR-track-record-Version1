...
export const HeartbeatTricolorIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2}>
    <defs>
      <linearGradient id="heartbeat-tricolor" x1="0" y1="0" x2="0" y2="1" gradientUnits="objectBoundingBox">
    ...
    <path stroke="url(#heartbeat-tricolor)" strokeLinecap="round" strokeLinejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
  </svg>
);
